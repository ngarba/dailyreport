...
for dk,dv in alldata.items():
    ...
    if cin == 'instr' and dv[3] == '2' or cin == 'instr' and dv[3] == '6' or cin == 'instr' and dv[3] == '9':
        continue                          # if subcat insselection isn't empty 'and' it's 2 SciOps Test
    ...
    if cin == 'sys' and dv[3] == '10':
        continue                          # if subcat system isn't empty 'and' it's 10 TechOps Testing
                                          # don't use it.
                                          # 6 is Technical Loss
...
'9': 'Instrument Group Testing', '10': 'TechOps Testing'}

...
#methobx = methob[1] - 7
#methoby = methob[3] - 5
#ax.text(methobx, methoby, 'Avg = ' + smeanacts)
...
plt.savefig(r'C:\Users\drsin\Documents\Work\Pictures\OCP reports\3.2 May-Jun 2025\graph.png')
#plt.show()